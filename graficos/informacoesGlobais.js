...
async function buscarInformacoes(){
    ...
    aproximadamente <span> ${pessoasConectadas} bilhões</span> estão conectadas em alguma rede social e passam em média 
    <span> ${horas}</span> horas e <span>${minutos}</span> minutos conectadas.
    Isso significa que aproximadamente <span>${porcentagemConectada}%</span> pessoas estão conectadas em alguma rede social.`;
